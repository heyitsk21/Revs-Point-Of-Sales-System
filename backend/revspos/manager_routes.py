...
class Employee(Resource):
    ...
    def get(self):
        ...
        with db.engine.connect() as conn:
            ...
            employeelist = []
            for row in result:
                employeelist.append({"employeeid":row.employeeid, "employeename":row.employeename, "email":row.email, "ismanager":row.ismanager, "salary":row.salary, "password":row.password})
